...
### Plan projektu  
- WERSJA PISEMNA: OKOŁO 10 STRON.  
	1. Jakim problemem się zajęliśmy i dlaczego. Zdefiniowanie celu projektu.  
	2. Jakie przedsiębiorstwa analizujemy + ich krótki opis.  
	3. Opis zastosowanych danych (statystyki opisowe) i źródła danych.  
	4. Rezultaty obliczeń efektywności.  
...
### Inputs  
- Direct staff costs  
- Number of human tellers  
- Number of computer terminals  
- Number of branches (in bank level analyses)  
- Number of ATMs[^2]  
- Office space[^3]  
- Total authorized FTE    
- Annual rent    
- Quality of customer service space ranking    
- Telephone/stationary expenses  
- Marketing activity ranking[^4]  
  
### Outputs  
- Number of mortgage applications  
- Number of mortgage applications  
- Number of transactions processed by human tellers  
- Number of insurance policies sold  
- Number of cash withdrawals  
- Number of new savings accounts  
- Number of loans processed  
- Number of transactions  
- Number of transactions effected at automatic teller machine[^5]  
- deposits  
